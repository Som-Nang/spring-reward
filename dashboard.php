      ...
      <div class="mb-6">
        ...
        <div>
          <ul class="mt-6 leading-10 px-4">
            <a href="index.php" class="mb-3 p-2 rounded-md flex items-center justify-center bg-blue-400 cursor-pointer" @click="openMenu !== 1 ? openMenu = 1 : openMenu = null">
              <i class="fas fa-align-left fa-sm text-white"></i>
            </a>
            <a href="#" class="mb-3 p-2 rounded-md flex items-center justify-center bg-pink-400 cursor-pointer">
      ...
      <main class="relative z-0 flex-1 pb-8 px-6 bg-white">
            ...
            <div class="relative w-full h-52 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out" style="background-image: url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f868ecef-4b4a-4ddf-8239-83b2568b3a6b/de7hhu3-3eae646a-9b2e-4e42-84a4-532bff43f397.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..R0h-BS0osJSrsb1iws4-KE43bUXHMFvu5PvNfoaoi8o');">
              ...
              <div class="relative w-full h-full px-4 sm:px-6 lg:px-4 flex items-center ">
                <div class="w-full">
                  ...
                  <?php
                  $sql = "SELECT SUM(tblprize.qty) AS sumPrize, COUNT(tblprize.id) AS countPrize FROM tblprize"; // Adjust the query based on your table structure
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  ...
                  ?>
                      <h3 class=" text-white text-3xl mt-2 font-bold">
                        ...
                        <?php echo htmlentities($row->sumPrize) ?> Items <br> <span class="text-sm"><?php echo htmlentities($row->countPrize) ?> Catagories</span>
                      </h3>
            ...
            <div class="relative w-full h-52 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out" style="background-image: url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f868ecef-4b4a-4ddf-8239-83b2568b3a6b/de7hhu3-3eae646a-9b2e-4e42-84a4-532bff43f397.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..R0h-BS0osJSrsb1iws4-KE43bUXHMFvu5PvNfoaoi8o');">
              ...
              <div class="relative w-full h-full px-4 sm:px-6 lg:px-4 flex items-center ">
                <div class="w-full">
                  ...
                  <?php
                  $sql = "SELECT COUNT(tbluser.id) AS countUser FROM tbluser"; // Adjust the query based on your table structure
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $results = $query->fetchAll(PDO::FETCH_OBJ);
                  ...
                  ?>
                      <h3 class=" text-white text-3xl mt-2 font-bold">
                        ...
                        <?php echo htmlentities($row->countUser) ?> Active Users
                      </h3>
                  <?php }
                  } ?>
                  <div class="flex justify-center item-center w-full space-x-4 mt-4">
            ...
            <div class="relative w-full h-52 bg-cover bg-center group rounded-lg overflow-hidden shadow-lg transition duration-300 ease-in-out" style="background-image: url('https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f868ecef-4b4a-4ddf-8239-83b2568b3a6b/de7hhu3-3eae646a-9b2e-4e42-84a4-532bff43f397.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..R0h-BS0osJSrsb1iws4-KE43bUXHMFvu5PvNfoaoi8o');">
              ...
              <div class="relative w-full h-full px-4 sm:px-6 lg:px-4 flex items-center ">
                <div class="w-full">
                  ...
                  <?php
                  $sql = "SELECT COUNT(tblwinner.id) AS countWinner FROM tblwinner"; // Adjust the query based on your table structure
                  $query = $dbh->prepare($sql);
                  $query->execute();
                  $results = $query->fetchAll(PDO::FETCH_OBJ);
                  ...
                  ?>
                      <h3 class=" text-white text-3xl mt-2 font-bold">
                        ...
                        <?php echo htmlentities($row->countWinner) ?> Users
                      </h3>
                  <?php }
                  } ?>
                  <div class="flex justify-center item-center w-full space-x-4 mt-4">
        ...
        <div id="myModal" class="modal">
          ...
          <main class="flex min-h-screen flex-col items-center justify-between p-6 lg:p-24">
            <form class="relative bg-white w-full max-w-3xl mx-auto px-4 lg:px-6 py-8 shadow-md rounded-md flex flex-col lg:flex-row">
              <span class="close">&times;</span>
              <div class="w-full lg:w-1/2 lg:pr-8 lg:border-r-2 lg:border-slate-300">

                <div class="mb-4">
                  <label class="text-neutral-800 font-bold text-sm mb-2 block">Item Name:</label>
                  <input type="text" class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 undefined" placeholder="Name" />
                </div>

                <div class="mb-4">
                  <label class="text-neutral-800 font-bold text-sm mb-2 block">Quality:</label>
                  <input type="text" class="flex h-10 w-full rounded-md border-2 bg-background px-4 py-1.5 text-lg ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-purple-600 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 undefined" placeholder="Name" />
                </div>
